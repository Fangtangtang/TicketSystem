...
public:
     ...
     * string
     */
    bool GetParameter(const char &key, std::string &str);
     ...
     * int
     */
    bool GetParameter(const char &key, int &num);
     ...
     * char*
     */
    bool GetParameter(const char &key, char *str);
     ...
     * char
     */
    bool GetParameter(const char &key, char &ch);
...
bool Parameter::GetParameter(const char &key, std::string &str) {
    if (para[key - 'a'].empty()) return false;
    str = para[key - 'a'];
    return true;
}

bool Parameter::GetParameter(const char &key, int &num) {
    if (para[key - 'a'].empty()) return false;
    num = 0;
...
bool Parameter::GetParameter(const char &key, char *str) {
    if (para[key - 'a'].empty()) return false;
    strcpy(str, para[key - 'a'].c_str());
    return true;
}

bool Parameter::GetParameter(const char &key, char &ch) {
    if (para[key - 'a'].empty()) return false;
    ch = para[key - 'a'][0];
    return true;
}
